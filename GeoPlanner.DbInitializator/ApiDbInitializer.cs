...
namespace GeoPlanner.DbInitializator;
    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    ...
    private static void SeedAdminUser(GeoPlannerDbContext dbContext)
    {
    ...
    private static async Task EnsureDatabaseAsync(GeoPlannerDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task RunMigrationAsync(GeoPlannerDbContext dbContext, CancellationToken cancellationToken)
    {
        var strategy = dbContext.Database.CreateExecutionStrategy();
        await strategy.ExecuteAsync(async () =>
        {
